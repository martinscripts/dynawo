...
model TransformerWithControl "Model of transformer with variable tap, for the Nordic 32 test system"
  ...
  */
  ...
  Dynawo.Electrical.Controls.Transformers.TapChanger tapChanger(U0 = U10Pu, UDeadBand = 0.01, UTarget = 1, increaseTapToIncreaseValue = false, locked0 = false, regulating0 = true, state0 = Dynawo.Electrical.Controls.Transformers.BaseClasses.TapChangerPhaseShifterParams.State.Standard, t1st = TransformerParameters.tfoParamValues[tfo, TransformerParameters.tfoParams.t1st], tNext = TransformerParameters.tfoParamValues[tfo, TransformerParameters.tfoParams.tNext], tap0(fixed = false), tapMax = TransformerParameters.NbTap - 1, tapMin = 0) annotation(
    Placement(visible = true, transformation(origin = {0, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Dynawo.Examples.Nordic.Components.TransformerWithControl.BaseClasses.InitializedTransformerVariableTap tfoVariableTap(SNom = TransformerParameters.tfoParamValues[tfo, TransformerParameters.tfoParams.SNom], X = TransformerParameters.tfoParamValues[tfo, TransformerParameters.tfoParams.X], Uc20Pu = TransformerParameters.tfoParamValues[tfo, TransformerParameters.tfoParams.Uc20Pu], G = 0, B = 0, R = 0, P10Pu = P10Pu, Q10Pu = Q10Pu, U10Pu = U10Pu, U1Phase0 = U1Phase0) annotation(
