...
model St1c "IEEE excitation system type ST1C model"
  ...
  Modelica.Blocks.Continuous.TransferFunction transferFunction1(a = {tB, 1}, b = {tC, 1}, x_start = {Efd0Pu / Ka}, y(start = Efd0Pu / Ka)) annotation(
  ...
  Modelica.Blocks.Continuous.TransferFunction transferFunction(a = {tB1, 1}, b = {tC1, 1}, x_start = {Efd0Pu / Ka}, y(start = Efd0Pu / Ka)) annotation(
